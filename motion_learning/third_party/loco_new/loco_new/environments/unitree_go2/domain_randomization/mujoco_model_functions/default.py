class DefaultDomainMuJoCoModel:
    def __init__(self, env,
                 friction_tangential_min=0.01, friction_tangential_max=1.5,
                 friction_torsional_ground_min=0.001, friction_torsional_ground_max=0.005,
                 friction_torsional_feet_min=0.0002, friction_torsional_feet_max=0.03,
                 friction_rolling_ground_min=0.00005, friction_rolling_ground_max=0.0002,
                 friction_rolling_feet_min=0.00003, friction_rolling_feet_max=0.001,
                 damping_min=50, damping_max=100,
                 stiffness_min=600, stiffness_max=1300,
                 gravity_min=9.00, gravity_max=10.51,
                 add_trunk_mass_min=-1.5, add_trunk_mass_max=1.5,
                 add_com_displacement_min=-0.005, add_com_displacement_max=0.005,
                 foot_size_min=0.021, foot_size_max=0.023,
                 joint_damping_min=0.0, joint_damping_max=0.8,
                 joint_armature_min=0.008, joint_armature_max=0.04,
                 joint_stiffness_min=0.0, joint_stiffness_max=1.0,
                 joint_friction_loss_min=0.0, joint_friction_loss_max=0.6,
        ):
        self.env = env
