class DefaultDomainControl:
    def __init__(self, env,
                 motor_strength_min=0.7, motor_strength_max=1.3,
                 p_gain_factor_min=0.7, p_gain_factor_max=1.3,
                 d_gain_factor_min=0.7, d_gain_factor_max=1.3,
                 asymmetric_factor_min=0.97, asymmetric_factor_max=1.03,
                 position_offset_min=-0.02, position_offset_max=0.03,
                 ):
        self.env = env
